...
class Suppliers(models.Model):
    ...
    supplier_phone_number = models.CharField(max_length=15, verbose_name='phone number', null=True, blank=True)
    supplier_email = models.CharField(max_length=50, verbose_name='email', null=True, blank=True)
    supplier_identification_number = models.CharField(max_length=20, verbose_name='identification number', null=True,
                                                      blank=True)
    ...
    supplier_accountable_person = models.CharField(max_length=100, verbose_name='accountable person', null=True,
                                                   blank=True)
    supplier_representatives = models.ForeignKey(SupplierRepresentatives, on_delete=models.CASCADE,
